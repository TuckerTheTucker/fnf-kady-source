...
class OriginalChartingState extends MusicBeatState
{
	...
	**/
	...
	{
		if (check_mustHitSection.checked) //updateheads gave me so much trouble im doing this instead
		{
			leftIcon.setPosition(0, -100);
			rightIcon.setPosition(gridBG.width / 2, -100);
		}
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = ForeverAssets.generateArrow(PlayState.assetModifier, daStrumTime, daNoteInfo % 4, daNoteType, 0, "default");
